...
class MenuUI:
    ...
    def display_table(self, credentials, mask_passwords=False, reveal_password=None, show_timestamps=True):
        """
        ...
        Args:
            ...
            show_timestamps (bool): If True, show created_at and updated_at timestamps
        """
        if not credentials:
            print()
    ...
    def _format_timestamp(timestamp):
        ...
        try:
            # Remove seconds from ISO timestamp
